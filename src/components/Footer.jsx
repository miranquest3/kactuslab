  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-[1600px] px-6 pt-24 pb-14 text-base md:px-12 md:text-sm lg:px-28">
        ...
        <p className="pt-10 text-center text-xs uppercase tracking-[0.2em] text-[#D4E5C0] md:pt-12">
          Powered by Miran
        </p>
      </div>
    </footer>
